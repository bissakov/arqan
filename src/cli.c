...
static const char g_usage[] =
    ...
    "\n"
    "environment: every setting is " AGENT_ENV_PREFIX
    "<NAME>, e.g. " AGENT_ENV_PREFIX "BASE_URL,\n" AGENT_ENV_PREFIX
    "MODEL, " AGENT_ENV_PREFIX "API_KEY, " AGENT_ENV_PREFIX
    "API, " AGENT_ENV_PREFIX "MAX_TOKENS, " AGENT_ENV_PREFIX
